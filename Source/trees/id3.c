...
#define __PYX_HAVE__ArchMM__Source__trees__id3
#define __PYX_HAVE_API__ArchMM__Source__trees__id3
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
 ...
 */
typedef double __pyx_t_6ArchMM_6Source_5trees_3id3_forwardBackwardProbs_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'ArchMM.Source.trees.id3' */
#define __Pyx_MODULE_NAME "ArchMM.Source.trees.id3"
int __pyx_module_is_main_ArchMM__Source__trees__id3 = 0;

/* Implementation of 'ArchMM.Source.trees.id3' */
...
/* "ArchMM/Source/trees/id3.pyx":11
 * ctypedef double forwardBackwardProbs_t
 * 
 * cdef inline double piStateCost(forwardBackwardProbs_t* gamma0, float* p, size_t n_states):             # <<<<<<<<<<<<<<
 *     """
...
static CYTHON_INLINE double __pyx_f_6ArchMM_6Source_5trees_3id3_piStateCost(__pyx_t_6ArchMM_6Source_5trees_3id3_forwardBackwardProbs_t *__pyx_v_gamma0, float *__pyx_v_p, size_t __pyx_v_n_states) {
  ...
  __Pyx_RefNannySetupContext("piStateCost", 0);

  /* "ArchMM/Source/trees/id3.pyx":21
 *     """
 *     cdef Py_ssize_t i
 ...
 */
  ...
  /* "ArchMM/Source/trees/id3.pyx":22
 *     cdef Py_ssize_t i
 *     cdef double cost = 0.0
 *     with nogil:             # <<<<<<<<<<<<<<
 *         for i in range(n_states):
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "ArchMM/Source/trees/id3.pyx":23
 *     cdef double cost = 0.0
 *     with nogil:
 *         for i in range(n_states):             # <<<<<<<<<<<<<<
 *             cost -= gamma0[i] * libc.math.log(p[i])
 *     return cost
 */
        __pyx_t_1 = __pyx_v_n_states;
        for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
          __pyx_v_i = __pyx_t_2;

          /* "ArchMM/Source/trees/id3.pyx":24
 *     with nogil:
 *         for i in range(n_states):
 *             cost -= gamma0[i] * libc.math.log(p[i])             # <<<<<<<<<<<<<<
 *     return cost
 * 
 */
          __pyx_v_cost = (__pyx_v_cost - ((__pyx_v_gamma0[__pyx_v_i]) * log((__pyx_v_p[__pyx_v_i]))));
        }
      }
 ...
 */
  ...
  /* "ArchMM/Source/trees/id3.pyx":25
 *         for i in range(n_states):
 *             cost -= gamma0[i] * libc.math.log(p[i])
 *     return cost             # <<<<<<<<<<<<<<
 * 
...
/* "ArchMM/Source/trees/id3.pyx":27
 *     return cost
 * 
 * cdef inline double stateTransitionCost(forwardBackwardProbs_t* xi, float* p, size_t n_states):             # <<<<<<<<<<<<<<
 *     """
...
static CYTHON_INLINE double __pyx_f_6ArchMM_6Source_5trees_3id3_stateTransitionCost(__pyx_t_6ArchMM_6Source_5trees_3id3_forwardBackwardProbs_t *__pyx_v_xi, float *__pyx_v_p, size_t __pyx_v_n_states) {
  Py_ssize_t __pyx_v_i;
  double __pyx_v_cost;
  double __pyx_r;
  __Pyx_RefNannyDeclarations
  size_t __pyx_t_1;
  Py_ssize_t __pyx_t_2;
  __Pyx_RefNannySetupContext("stateTransitionCost", 0);

  /* "ArchMM/Source/trees/id3.pyx":37
 *     """
 *     cdef Py_ssize_t i
 *     cdef double cost = 0.0             # <<<<<<<<<<<<<<
 *     with nogil:
 ...
 */
  ...
  /* "ArchMM/Source/trees/id3.pyx":38
 *     cdef Py_ssize_t i
 *     cdef double cost = 0.0
 *     with nogil:             # <<<<<<<<<<<<<<
 *         for i in range(n_states):
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "ArchMM/Source/trees/id3.pyx":39
 *     cdef double cost = 0.0
 *     with nogil:
 *         for i in range(n_states):             # <<<<<<<<<<<<<<
 *             cost -= xi[i] * libc.math.log(p[i])
 ...
 */
        ...
        for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
          ...
          /* "ArchMM/Source/trees/id3.pyx":40
 *     with nogil:
 *         for i in range(n_states):
 *             cost -= xi[i] * libc.math.log(p[i])             # <<<<<<<<<<<<<<
 *     return cost
 */
          __pyx_v_cost = (__pyx_v_cost - ((__pyx_v_xi[__pyx_v_i]) * log((__pyx_v_p[__pyx_v_i]))));
        }
      }
 ...
 */
  ...
  /* "ArchMM/Source/trees/id3.pyx":41
 *         for i in range(n_states):
 *             cost -= xi[i] * libc.math.log(p[i])
 *     return cost             # <<<<<<<<<<<<<<
 */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initid3(void); /*proto*/
PyMODINIT_FUNC initid3(void)
#else
PyMODINIT_FUNC PyInit_id3(void); /*proto*/
PyMODINIT_FUNC PyInit_id3(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_id3(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("id3", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_ArchMM__Source__trees__id3) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "ArchMM.Source.trees.id3")) {
      if (unlikely(PyDict_SetItemString(modules, "ArchMM.Source.trees.id3", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init ArchMM.Source.trees.id3", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init ArchMM.Source.trees.id3");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
