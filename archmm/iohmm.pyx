                ...
                if not is_mv[j, k]:
                    with nogil:
                        for i in range(n):
                            ...
                            ln_alpha[j, i, k] = elnproduct(logalpha, B[j, i, k, <Py_ssize_t>targets_buf[j][k]])
                        ...
                        for l in range(n):
                            logbeta = elnsum(
                                ...
                                elnproduct(
                                    A[j, k + 1, i, l],
                                    elnproduct(
                                        B[j, l, k + 1, <Py_ssize_t>targets_buf[j][k + 1]],
                                        ln_beta[j, l, k + 1]
                                    )
                                )
                            )
                    ...
                    for l in range(n):
                        ln_xi[j, i, k, l] = elnproduct(
                            ...
                            elnproduct(
                                ...
                                elnproduct(
                                    ln_beta[j, i, k + 1],
                                    B[j, l, k + 1, <Py_ssize_t>targets_buf[j][k + 1]] # B[j, l, k + 1, <Py_ssize_t>targets[j][k]] ?
                                )
                            )
                        )
